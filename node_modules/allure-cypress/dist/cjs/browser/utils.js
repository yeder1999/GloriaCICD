...
exports.uint8ArrayToBase64 = exports.resolveSpecRelativePath = exports.resolveRenderProps = exports.resolveConsoleProps = exports.markTestAsReported = exports.iterateTests = exports.iterateSuites = exports.isTestReported = exports.isRootAfterAllHook = exports.isLastRootAfterHook = exports.isAllureHook = exports.getTestStopData = exports.getTestStartData = exports.getTestSkipData = exports.getTestMetadata = exports.getSuiteTitlePath = exports.getSuitePath = exports.getStepStopData = exports.getStatusDataOfTestSkippedByHookError = exports.getFileNameFromPath = exports.generateApiStepId = void 0;
...
var resolveConsoleProps = entry => {
  // consoleProps can be a function or an object(cy.origin just return an object)
  return typeof entry.attributes.consoleProps === "function" ? entry.attributes.consoleProps() : entry.attributes.consoleProps;
};
exports.resolveConsoleProps = resolveConsoleProps;
var resolveRenderProps = entry => {
  var _entry$attributes, _entry$attributes2;
  // renderProps can be a function or an object(cy.origin just return an object)
  return typeof (entry === null || entry === void 0 || (_entry$attributes = entry.attributes) === null || _entry$attributes === void 0 ? void 0 : _entry$attributes.renderProps) === "function" ? entry.attributes.renderProps() : (_entry$attributes2 = entry.attributes) === null || _entry$attributes2 === void 0 ? void 0 : _entry$attributes2.renderProps;
};

...
var getIndicesOfDeselectedTests = (testPlan, spec, specPath, tests) => {
  var indicesToRemove = [];
  var projectName = (0, _state.getProjectName)();
  var fullNameBase = projectName ? "".concat(projectName, ":").concat(specPath) : specPath;
  tests.forEach((test, index) => {
    ...
    var fullName = "".concat(fullNameBase, "#").concat(fullNameSuffix);

...
class AllureCypress {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _addNewTestResult, (context, fullNameSuffix, _ref7, scopes) => {
      ...
      var projectName = (0, _reporter.getProjectName)();
      ...
      return this.allureRuntime.startTest(_objectSpread({
        ...
        labels: [(0, _reporter.getLanguageLabel)(), (0, _reporter.getFrameworkLabel)("cypress"), ...(0, _reporter.getSuiteLabels)(context.suiteNames), ...metadataLabels, ...(0, _reporter.getEnvironmentLabels)(), (0, _reporter.getHostLabel)(), (0, _reporter.getThreadLabel)(), (0, _reporter.getPackageLabel)(context.specPath), (0, _reporter.getFallbackTestCaseIdLabel)((0, _reporter.md5)(legacyFullName))],
...
var createRuntimeState = allureConfig => ({
  ...
  projectName: (0, _reporter.getProjectName)(),
  stepStack: [],
  stepsToFinalize: [],
  nextApiStepId: 0
});
var getRuntimeConfigDefaults = function getRuntimeConfigDefaults() {
  var {
    stepsFromCommands: {
      enabled = _utils.DEFAULT_RUNTIME_CONFIG.stepsFromCommands.enabled,

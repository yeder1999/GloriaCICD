...
var SYNC_STEP_PURE_FUNCTION_ERROR = "allure-js-commons/sync step body must be synchronous and must not return a Promise";
...
class AllureCypressTestRuntime {
  ...
  get sync() {
    return _assertClassBrand(_AllureCypressTestRuntime_brand, this, _createSyncRuntime).call(this);
  }
  labels() {
...
function _createSyncRuntime() {
  return {
    ...
    parameter: (name, value, options) => enqueueRuntimeMessage({
      type: "metadata",
      data: {
        parameters: [_objectSpread({
          name,
    ...
    description: markdown => enqueueRuntimeMessage({
      type: "metadata",
      data: {
        description: markdown
      }
    }),
    descriptionHtml: html => enqueueRuntimeMessage({
      type: "metadata",
      data: {
        descriptionHtml: html
      }
    }),
    displayName: name => enqueueRuntimeMessage({
      type: "metadata",
      data: {
        displayName: name
      }
    }),
    historyId: value => enqueueRuntimeMessage({
      type: "metadata",
      data: {
        historyId: value
      }
    }),
    testCaseId: value => enqueueRuntimeMessage({
      type: "metadata",
      data: {
        testCaseId: value
      }
    ...
    attachmentFromPath: (name, path, options) => enqueueRuntimeMessage({
      type: "attachment_path",
      data: {
        name,
        path,
    ...
    globalAttachmentFromPath: (name, path, options) => enqueueRuntimeMessage({
      type: "global_attachment_path",
      data: {
        name,
        path,
    ...
    globalError: details => enqueueRuntimeMessage({
      type: "global_error",
      data: details
    }),
    ...
    stepDisplayName: name => enqueueRuntimeMessage({
      type: "step_metadata",
      data: {
        name
      }
    }),
    stepParameter: (name, value, mode) => enqueueRuntimeMessage({
      type: "step_metadata",
      data: {
        parameters: [{
          name,

...
import { ReporterRuntime, createDefaultWriter, getEnvironmentLabels, getFallbackTestCaseIdLabel, getFrameworkLabel, getHostLabel, getLanguageLabel, getPackageLabel, getPosixPath, getProjectName, getProjectRoot, getRelativePath, getSuiteLabels, getThreadLabel, md5, parseTestPlan } from "allure-js-commons/sdk/reporter";
import { DEFAULT_RUNTIME_CONFIG, last } from "./utils.js";
var _fixtureNames = /*#__PURE__*/new WeakMap();
...
export class AllureCypress {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _fixtureNames, new Map());
    ...
    _classPrivateFieldInitSpec(this, _startHook, (context, _ref4) => {
      ...
      if (scope) {
        ...
        if (context.fixture) {
          _classPrivateFieldGet(_fixtureNames, this).set(context.fixture, name);
        }
      }
    });
    _classPrivateFieldInitSpec(this, _stopHook, (context, _ref5) => {
      ...
      if (fixtureUuid) {
        ...
        _classPrivateFieldGet(_fixtureNames, this).delete(fixtureUuid);
    ...
    _classPrivateFieldInitSpec(this, _addNewTestResult, (context, fullNameSuffix, _ref7, scopes) => {
      ...
      var fullNameBase = projectName ? "".concat(projectName, ":").concat(posixPath) : posixPath;
      var legacyFullName = "".concat(posixPath, "#").concat(fullNameSuffix);
      var titlePath = posixPath.split("/").concat(context.suiteNames);
      return this.allureRuntime.startTest(_objectSpread({
        stage: Stage.RUNNING,
        labels: [getLanguageLabel(), getFrameworkLabel("cypress"), ...getSuiteLabels(context.suiteNames), ...metadataLabels, ...getEnvironmentLabels(), getHostLabel(), getThreadLabel(), getPackageLabel(context.specPath), getFallbackTestCaseIdLabel(md5(legacyFullName))],
        fullName: "".concat(fullNameBase, "#").concat(fullNameSuffix),
    ...
    _classPrivateFieldInitSpec(this, _failHookAndTest, (context, _ref8) => {
      ...
      if (fixtureUuid) {
        ...
        this.allureRuntime.applyGlobalRuntimeMessages([toGlobalErrorMessage((_classPrivateFieldGet2 = _classPrivateFieldGet(_fixtureNames, this).get(fixtureUuid)) !== null && _classPrivateFieldGet2 !== void 0 ? _classPrivateFieldGet2 : "hook", statusDetails)]);
      }
...
var toGlobalErrorMessage = (name, details) => ({
  type: "global_error",

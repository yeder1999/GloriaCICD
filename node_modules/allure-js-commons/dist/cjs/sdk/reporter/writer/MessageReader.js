    ...
    _defineProperty(this, "handleMessage", jsonMessage => {
      ...
      switch (type) {
        ...
        case "attachment":
          ...
          return;
        case "globals":
          this.results.globals = (_this$results$globals = this.results.globals) !== null && _this$results$globals !== void 0 ? _this$results$globals : {};
          this.results.globals[path] = parseJsonResult(data);
          return;
        case "misc":
          switch (path) {
            case "environment.properties":
              this.results.envInfo = (0, _envInfo.parseEnvInfo)(Buffer.from(data, "base64").toString());
              break;
    ...
    _defineProperty(this, "attachResults", /*#__PURE__*/_asyncToGenerator(function* () {
      yield (0, _facade.step)("allure-results", /*#__PURE__*/_asyncToGenerator(function* () {
        ...
        if (_this.results.envInfo) {
          yield (0, _facade.attachment)("environment.properties", (0, _envInfo.stringifyEnvInfo)(_this.results.envInfo), "text/plain");
        }
        ...
        if (_this.results.globals) {
          for (var _key of Object.keys(_this.results.globals)) {
            yield (0, _facade.attachment)(_key, JSON.stringify(_this.results.globals[_key], null, 2), {
              contentType: "application/json",
              encoding: "utf-8"
            });
          }

...
export declare const FALLBACK_TEST_CASE_ID_LABEL_NAME = "_fallbackTestCaseId";
export declare const getFallbackTestCaseIdLabel: (value: string) => Label;
...
export declare const getProjectRoot: (searchFrom?: string) => string;
export declare const getProjectName: (searchFrom?: string) => string | undefined;
export declare const getRelativePath: (filepath: string, searchFrom?: string) => string;

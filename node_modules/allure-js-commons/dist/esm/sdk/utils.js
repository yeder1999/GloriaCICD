...
export var isGlobalRuntimeMessage = message => {
...
export var composeReplacers = (first, second) => function (k, v) {
  return second.call(this, k, first.call(this, k, v));
};
export var excludeCircularRefsFromMap = (parents, map) => {
...
export var excludeCircularRefsFromSet = (parents, set) => {
  return Array.from(set).map(v => parents.includes(v) ? undefined : v);
};
export var limitString = (value, maxLength) => maxLength && value.length > maxLength ? "".concat(value.substring(0, maxLength), "...") : value;

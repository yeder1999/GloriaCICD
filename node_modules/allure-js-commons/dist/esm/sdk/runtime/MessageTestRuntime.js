...
export class BaseMessageTestRuntime {
  constructor() {
  ...
  step(name, body) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        var details = getMessageAndTraceFromError(err);
        yield _this13.sendMessage({
          type: "step_stop",
          data: {
  ...
  createSyncPromiseError() {
    var error = new Error(SYNC_STEP_PURE_FUNCTION_ERROR);
    ...
    return {
      ...
      step: (name, body) => {
        ...
        try {
          ...
          var error = err;
          var details = getMessageAndTraceFromError(error);
          var status = error.message === SYNC_STEP_PURE_FUNCTION_ERROR ? Status.BROKEN : getStatusFromError(error);
          sendMessageSync({
            type: "step_stop",
            data: {
              status,
...
export class MessageTestRuntime extends BaseMessageTestRuntime {
  attachment(name, content, options) {
    var _this16 = this;
    return _asyncToGenerator(function* () {

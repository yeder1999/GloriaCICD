...
export var FALLBACK_TEST_CASE_ID_LABEL_NAME = "_fallbackTestCaseId";
export var getFallbackTestCaseIdLabel = value => ({
...
export var getProjectRoot = (() => {
  var cachedProjectRootBySearchFrom = new Map();
  var resolveSearchDir = searchFrom => {
    var target = path.resolve(searchFrom !== null && searchFrom !== void 0 ? searchFrom : process.cwd());
    try {
  ...
  var resolveProjectRootByPath = searchFrom => {
    var searchDir = resolveSearchDir(searchFrom);
    var dir = searchDir;
    while (true) {
      try {
  ...
  return searchFrom => {
    var searchDir = resolveSearchDir(searchFrom);
    var cachedProjectRoot = cachedProjectRootBySearchFrom.get(searchDir);
    if (cachedProjectRoot) {
      return cachedProjectRoot;
    }
    var projectRoot = resolveProjectRootByPath(searchDir);
    cachedProjectRootBySearchFrom.set(searchDir, projectRoot);
    return projectRoot;
  };
})();
export var getProjectName = (() => {
  var cachedProjectNameByRoot = new Map();
  return searchFrom => {
    var projectRoot = getProjectRoot(searchFrom);
...
export var getRelativePath = (filepath, searchFrom) => {

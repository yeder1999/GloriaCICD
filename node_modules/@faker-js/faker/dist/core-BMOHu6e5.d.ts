 ...
 */
//#endregion
//#region src/modules/animal/module.d.ts
/**
...
//#endregion
//#region src/modules/book/module.d.ts
/**
 ...
 * The strategy to apply when no words with a matching length are found.
 */
type LengthStrategyType = `${LengthStrategy}`;
//#endregion
//#region src/modules/color/module.d.ts
/**
...
//#endregion
//#region src/modules/commerce/module.d.ts
/**
...
//#endregion
//#region src/modules/company/module.d.ts
/**
...
//#endregion
//#region src/modules/database/module.d.ts
/**
...
//#endregion
//#region src/modules/date/module.d.ts
/**
...
//#endregion
//#region src/modules/finance/module.d.ts
/**
...
//#endregion
//#region src/modules/food/module.d.ts
/**
...
//#endregion
//#region src/modules/git/module.d.ts
/**
...
//#endregion
//#region src/modules/hacker/module.d.ts
/**
...
//#endregion
//#region src/modules/helpers/module.d.ts
/**
...
//#endregion
//#region src/modules/person/module.d.ts
/**
...
//#endregion
//#region src/modules/image/module.d.ts
/**
...
//#endregion
//#region src/modules/internet/module.d.ts
...
//#endregion
//#region src/modules/location/module.d.ts
/**
...
//#endregion
//#region src/modules/lorem/module.d.ts
/**
...
declare class LoremModule extends ModuleBase {
   ...
   * @since 2.0.1
   */
  words(wordCount?: NumberOrRange): string;
  /**
   ...
   * @since 2.0.1
   */
  sentence(wordCount?: NumberOrRange): string;
  /**
   ...
   * @since 4.0.0
   */
  slug(wordCount?: NumberOrRange): string;
  /**
   ...
   * @since 2.0.1
   */
  sentences(sentenceCount?: NumberOrRange, separator?: string): string;
  /**
   ...
   * @since 2.0.1
   */
  paragraph(sentenceCount?: NumberOrRange): string;
  /**
   ...
   * @since 2.0.1
   */
  paragraphs(paragraphCount?: NumberOrRange, separator?: string): string;
  /**
   ...
   * @since 3.1.0
   */
  lines(lineCount?: NumberOrRange): string;
}
//#endregion
//#region src/modules/music/module.d.ts
/**
...
//#endregion
//#region src/modules/phone/module.d.ts
/**
...
//#endregion
//#region src/modules/science/module.d.ts
/**
...
//#endregion
//#region src/modules/system/module.d.ts
...
//#endregion
//#region src/modules/vehicle/module.d.ts
/**
...
//#endregion
//#region src/modules/word/module.d.ts
/**
...
//#endregion
//#region src/modules/datatype/module.d.ts
/**
...
//#endregion
//#region src/modules/number/module.d.ts
/**
...
//#endregion
//#region src/modules/string/module.d.ts
...
declare class StringModule extends SimpleModuleBase {
   ...
   * @since 8.0.0
   */
  fromCharacters(characters: string | ReadonlyArray<string>, length?: NumberOrRange): string;
  /**
   ...
   * @since 8.0.0
   */
  sample(length?: NumberOrRange): string;
  /**
   ...
   * @since 8.0.0
   */
  nanoid(length?: NumberOrRange): string;
  /**
   ...
   * @since 8.0.0
   */
  symbol(length?: NumberOrRange): string;
}
//#endregion
...
//#endregion
//#region src/modules/airline/module.d.ts
 ...
 * @since 10.5.0
 */
declare function createFakerCore(options?: FakerOptions): FakerCore;
//#endregion
export { SimpleLocationModule as $, BookDefinition as A, StringColorFormat as At, Distributor as B, DateDefinition as C, ColorFormat as Ct, CommerceDefinition as D, CssSpace as Dt, CompanyDefinition as E, CssFunctionType as Et, Faker as F, NumberRange as Ft, SystemModule as G, DatatypeModule as H, SimpleFaker as I, BookModule as It, Unit as J, ChemicalElement as K, simpleFaker as L, AnimalModule as Lt, Aircraft as M, LengthStrategy as Mt, AircraftType as N, LengthStrategyType as Nt, CommerceProductNameDefinition as O, CssSpaceType as Ot, AirlineModule as P, NumberOrRange as Pt, LocationModule as Q, StringModule as R, FakerConfig as Rt, FinanceDefinition as S, CommerceModule as St, DatabaseDefinition as T, CssFunction as Tt, WordModule as U, Randomizer as V, VehicleModule as W, MusicModule as X, PhoneModule as Y, LoremModule as Z, LoremDefinition as _, BitcoinNetworkType as _t, LocaleDefinition as a, Sex as at, HackerDefinition as b, DatabaseModule as bt, VehicleDefinition as c, SimpleHelpersModule as ct, ScienceDefinition as d, FoodModule as dt, IPv4Network as et, PhoneNumberDefinition as f, Currency as ft, MetadataDefinition as g, BitcoinNetwork as gt, MusicDefinition as h, BitcoinAddressFamilyType as ht, AirlineDefinition as i, PersonModule as it, AnimalDefinition as j, Casing as jt, ColorDefinition as k, NumberColorFormat as kt, SystemDefinition as l, HackerModule as lt, PersonEntryDefinition as m, BitcoinAddressFamily as mt, FakerOptions as n, InternetModule as nt, LocaleEntry as o, SexType as ot, PersonDefinition as p, FinanceModule as pt, ScienceModule as q, createFakerCore as r, ImageModule as rt, WordDefinition as s, HelpersModule as st, FakerCore as t, IPv4NetworkType as tt, SystemMimeTypeEntryDefinition as u, GitModule as ut, LocationDefinition as v, DateModule as vt, DateEntryDefinition as w, ColorModule as wt, FoodDefinition as x, CompanyModule as xt, InternetDefinition as y, SimpleDateModule as yt, NumberModule as z };